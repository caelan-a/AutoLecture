...
class SubjectConfirmationFrame(QWidget): 
	def __init__(self, parent, assets):
		...
		self.layout.addWidget(confirmSubjectWidget("Linear Algebra", "2", "2017", "MAST10007",assets.icon_subject_icon), 0, Qt.AlignCenter)
		self.layout.addWidget(confirmSubjectWidget("Engineering Systems Design", "2", "2017", "ENGR10003",assets.icon_subject_icon), 0, Qt.AlignCenter)
		self.layout.addWidget(confirmSubjectWidget("Physics", "2", "2017", "PHYC10004",assets.icon_subject_icon), 0, Qt.AlignCenter)
